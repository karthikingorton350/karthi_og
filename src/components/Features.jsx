    ...
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        ...
        <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          Here I had add some of cool Transition Effects to look more attractive
          of my personal and my protfolio projects details
        </p>
      </div>
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
          <BentoCard
            ...
            title={
              <a
                href="https://karthikeyan-3d-personal.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                3D <b>W</b>ebsite
        ...
        <BentoTilt className="bento-tilt_2 relative">
          ...
          <button
            ...
            className="absolute bottom-4 right-4 px-4 py-2 text-sm text-white bg-blue-500 rounded shadow hover:bg-blue-600 transition"
          >
            🔇
          </button>
        </BentoTilt>
